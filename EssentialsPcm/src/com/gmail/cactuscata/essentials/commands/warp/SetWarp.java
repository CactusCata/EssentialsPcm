...
import com.gmail.cactuscata.essentials.maths.Maths;
...
public class SetWarp implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		p.sendMessage(PrefixMessage.PREFIX + "Le warp " + args[0] + " a été créer en x: " + x + ", y: " + y + ", z: "
				+ z + ", pitch: " + pitch + ", yaw: " + yaw + ", monde: " + world.toString() + " !");
