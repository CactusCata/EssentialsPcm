...
public class Gamemode implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (player.hasPermission("essentials.gamemode." + gamemode[value].toString().toLowerCase())) {

			player.setGameMode(gamemode[value]);
			player.sendMessage(
					PrefixMessage.PREFIX + "Vous avez été mis en " + gamemode[value].toString().toLowerCase() + " !");
			return true;
		}
